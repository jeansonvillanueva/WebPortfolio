...
export function PinIcon({ size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M12 21s7-5.4 7-11a7 7 0 1 0-14 0c0 5.6 7 11 7 11Z" stroke="currentColor" strokeWidth="2" />
...
export function PhoneIcon({ size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M6.5 3.5h3l1.2 4-2 1.2a12.5 12.5 0 0 0 6.6 6.6l1.2-2 4 1.2v3c0 .8-.7 1.5-1.6 1.4C9.8 18.2 5.8 14.2 4.1 5.1c-.1-.9.6-1.6 1.4-1.6Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
    </svg>
  );
}
...
export function LinkedinIcon({ size = 16 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M6.54 8.5H3.76V20h2.78V8.5ZM5.14 3.5A1.62 1.62 0 1 0 5.15 6.74 1.62 1.62 0 0 0 5.14 3.5ZM20.24 20h-2.78v-5.6c0-1.34-.03-3.05-1.86-3.05-1.86 0-2.15 1.45-2.15 2.95V20h-2.78V8.5h2.67v1.57h.04c.37-.7 1.28-1.86 2.95-1.86 3.16 0 3.74 2.08 3.74 4.78V20Z" />
    </svg>
  );
}
